...
import { loadScene, scriptsDictionary, scriptAssetsCache, _applyScriptsForObject, _preloadScriptsAssets } from "babylonjs-editor-tools";
...
import * as scripts_icon_drawer from "./scripts/icon-drawer";
...
export const scriptsMap = {
	...
	"scripts/icon-drawer.ts": scripts_icon_drawer,
	"scripts/text-block.ts": scripts_text_block,
	"scripts/input-field.ts": scripts_input_field
};

export { loadScene, scriptsDictionary, scriptAssetsCache, _applyScriptsForObject, _preloadScriptsAssets };
